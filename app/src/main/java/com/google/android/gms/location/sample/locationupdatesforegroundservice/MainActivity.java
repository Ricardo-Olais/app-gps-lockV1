    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // email = (EditText) findViewById(R.id.usuarioemail);
        ...
        if (active == false){
            ...
            intent.putExtra(DevicePolicyManager.EXTRA_ADD_EXPLANATION, "Permiso para que el usuario no pueda desinstalar la app Localizaminave");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_QR_SCAN) {
            if (data != null) {
                    ...
                    public void run() {
                        ...
                        try  {
                            try {
                                ...
                                url = new URL("http://localizaminave.com:8080/api/recibeqr/"+lectura+"-"+imei);
                ...
                Toast.makeText(getApplicationContext(), "Dispositivo sincronizado con éxito", Toast.LENGTH_SHORT).show();
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                       ...
                       // System.out.println("http://www.fasttransfer.com.mx:8080/inserta?imei="+imei+"&usuario="+email.getText().toString().trim()+"&valores="+Utils.getLocationText(location)+"&pila="+bateria);
                        try  {
                            try {
                                System.out.println("http://localizaminave.com:8080/api/gps/"+imei+"/"+Utils.getLocationText(location)+"/"+bateria);
                                url = new URL("http://localizaminave.com:8080/api/gps/"+imei+"/"+Utils.getLocationText(location)+"/"+bateria);
                                //String A="https://www.fasttransfer.com.mx/api/gps/"+imei+"/"+Utils.getLocationText(location)+"/"+bateria;
